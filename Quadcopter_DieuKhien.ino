...
void loop() {
 ...
 if (state == '1' && speeds1 <=250){//tang toc motor1
    speeds1 = speeds1+5;
    state =0;
    delay(5);
    }else
    if (state == '2'&& speeds2 <=250){//tang toc moto2
    speeds2 = speeds2+5;
    state =0;
    delay(5);
    }else
    if (state == '3'&& speeds3 <=250){//tang toc motor3
      speeds3 = speeds3+5;
      state =0;
      delay(5);
    }else
    if (state == '4'&& speeds4 <=250){  //tang toc motor4
      speeds4 = speeds4+5;
      state =0;
      delay(5);
    }else
